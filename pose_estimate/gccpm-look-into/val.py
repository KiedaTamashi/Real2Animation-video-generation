...
from datasets.anime import AnimeValDataset
...
def evaluate(dataset, output_name, net, multiscale=False, visualize=False,num_kps=16):
    net = net.cuda().eval()
    base_height = 256
    scales = [1]
    if multiscale:
...
if __name__ == '__main__':
    ...
    if data_flag=="real":
        ...
        dataset = AnimeValDataset(args.dataset_folder)
    evaluate(dataset, args.output_name, net, args.multiscale, args.visualize,num_kps=args.num_kps)
